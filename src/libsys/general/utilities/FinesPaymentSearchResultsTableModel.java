...
public class FinesPaymentSearchResultsTableModel extends AbstractTableModel
{
		ResultSet rs;
		ResultSetMetaData rsmd;
		LIBSYSSystem LibrarySystem;
		public FinesPaymentSearchResultsTableModel(LIBSYSSystem LibrarySystem, ResultSet rs)
		{
				this.rs = rs;
		...
		public String getColumnName(int c)
               {
				...
				switch(c)
				{
						...
						case 2 : ColumnName =  "Fine Amount";
								break;
						case 3 : ColumnName =  "Paid";
								break;
						case 4 : ColumnName =  "Reason";
								break;
				}				
