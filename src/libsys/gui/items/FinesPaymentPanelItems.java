...
public class FinesPaymentPanelItems 
{
		public javax.swing.JLabel borroweraccnumber_label;
                ...
                public javax.swing.JLabel finedetails_label;
                public javax.swing.JScrollPane finedetails_scrollpane;
                public javax.swing.JButton finedetailsprint_btn;
                public javax.swing.JPanel finespayment_panel;
                public javax.swing.JScrollPane finespayment_scrollpane;
                public javax.swing.JLabel imagedestination_label;
                public javax.swing.JButton payfine_btn;
                public javax.swing.JButton print_btn;
                public javax.swing.JPanel searchresults_panel;
		
		public JTable ResultsTable;
		
		public FinesPaymentPanelItems() 
		{
				finespayment_scrollpane = new javax.swing.JScrollPane();
                                finespayment_panel = new javax.swing.JPanel();
                                ...
                                finedetails_label = new javax.swing.JLabel();
                                finedetailsprint_btn = new javax.swing.JButton();
                                finedetails_scrollpane = new javax.swing.JScrollPane();
                                payfine_btn = new javax.swing.JButton();
                                print_btn = new javax.swing.JButton();
				
				borroweraccnumber_txt.setToolTipText("Enter Text and Press TAB");

                                finespayment_panel.setBackground(new java.awt.Color(204, 204, 255));
				...
				borroweraddress_textarea.setBackground(Color.WHITE);
                                ...
                                fineamount_label.setText("Total Fine Amount :");

                                fineamount_txt.setEditable(false);
				fineamount_txt.setBackground(Color.WHITE);
                                ...
                                searchresults_panel.setBackground(new java.awt.Color(153, 153, 255));

                                finedetails_label.setText("Fine Details :");

                                finedetailsprint_btn.setText("Print Fine Details");
				
				payfine_btn.setText("Pay Fine");

                                print_btn.setText("Print Payment");
				print_btn.setEnabled(false);
				print_btn.setVisible(false);
				
				finespayment_scrollpane.setViewportView(finespayment_panel);
		}
