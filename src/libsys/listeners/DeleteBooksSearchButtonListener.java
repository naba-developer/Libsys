		...
		public void actionPerformed(ActionEvent ae)
		{
				if(ae.getActionCommand().equals("Search"))
				{
						...
						try
						{
								...
								LibrarySystem.FrameItems.deleteBooksPanelItems.searchprogress_progressbar.setValue(LibrarySystem.FrameItems.deleteBooksPanelItems.searchprogress_progressbar.getMaximum());
						}
						catch(Exception ex)
						{
